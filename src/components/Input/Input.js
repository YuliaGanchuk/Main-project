...
export const Input = ({text, onchangeFunc, onclickFunc}) =>{
 ...
 return(
    <div className={styles.mainContainer}>
        ...
        <input className= {styles.inputContainer} type= "text" value={text} onChange={onchangeFunc} placeholder = "Search Movies or TV Shows"></input>
        <button onClick={onclickFunc} className= {styles.clearButton}>
            {text && <img className={styles.icon} src={closeIcon} alt = "clear text icon"></img>}
        </button>
