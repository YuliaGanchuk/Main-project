      ...
      return (
        ...
        <div className="sug-containerImageShow">
          ...
          <div className='raiting'>
              ...
              <span className='span'>{this.state.skeleton.rating.average || 0}</span>   
          </div>
          <Link to={`/show-details/${this.props.id}`} state={{id: this.props.id}}>     
          <p className='sug-p'>{this.state.skeleton.name}</p>
          <div className='like'>
            <svg className='sug-svg' width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M6.48001 17.35L9.58001 19.75C9.98001 20.15 10.88 20.35 11.48 20.35H15.28C16.48 20.35 17.78 19.45 18.08 18.25L20.48 10.95C20.98 9.55 20.08 8.35 18.58 8.35H14.58C13.98 8.35 13.48 7.85 13.58 7.15L14.08 3.95C14.28 3.05 13.68 2.05 12.78 1.75C11.98 1.45 10.98 1.85 10.58 2.45L6.48001 8.55"  stroke-width="1.5" stroke-miterlimit="10"/>
                <path d="M1.38 17.35V7.54999C1.38 6.14999 1.98 5.64999 3.38 5.64999H4.38C5.78 5.64999 6.38 6.14999 6.38 7.54999V17.35C6.38 18.75 5.78 19.25 4.38 19.25H3.38C1.98 19.25 1.38 18.75 1.38 17.35Z"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
