...
export class MovieCard extends React.Component {
    ...
    render () {
      return (<div className={"card-blok"}>
        <div className='show'>           
          <a href="/"><img className='image' src={this.state.skeleton.image.medium} alt="slide" /></a>
          ...
          <p className="text-name">{this.state.skeleton.name}</p>
        </div>
        </div>);
